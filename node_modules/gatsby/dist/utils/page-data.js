...
async function flush() {
  ...
  const flushQueue = (0, _fastq.default)(async (pagePath, cb) => {
    ...
    if (page) {
      ...
      if ((program === null || program === void 0 ? void 0 : (_program$_ = program._) === null || _program$_ === void 0 ? void 0 : _program$_[0]) === `develop` && process.env.GATSBY_EXPERIMENTAL_QUERY_ON_DEMAND || ("4" === `4` ? page.mode !== `SSG` : false)) {
